...
export default function StudyMaterialPage({ params }: { params: Promise<{ caseId: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        ...
        <button onClick={() => router.push(`/cases/${currentCase.id}/results`)} className="btn btn-secondary text-sm">Back to Results</button>
      </div>
      ...
      <div className="glass-card mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <select 
            ...
            style={{ width: 'auto', minWidth: '240px', padding: '0.6rem 1rem', cursor: 'pointer' }}
          >
            <option value="Quick">Quick Review (3-5 min)</option>
            <option value="Standard">Standard Review (8-12 min)</option>
            <option value="Deep">Deep Review (15-25 min)</option>
          </select>
          <button 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="glass-card bg-[var(--error-bg)] border-[var(--error)]/20">
              ...
              {existingMaterial.examTraps && existingMaterial.examTraps.length > 0 && (
                <>
                  <h4 className="font-bold text-sm mb-2 mt-4">Exam Traps:</h4>
                  <ul className="list-disc pl-5 text-sm space-y-1">
